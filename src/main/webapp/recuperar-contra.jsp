...
<%
  ...
  Long tiempoEnvio = (Long) session.getAttribute("tiempoEnvioCodigo");
%>
<!doctype html>
<html lang="es">
<head>
...
<!-- Inputs Ocultos para comunicar Java con JS de forma limpia -->
<input type="hidden" id="serverStep" value="<%= step %>">
<input type="hidden" id="serverErrorMsg" value="<%= error != null ? error : "" %>">
  ...
  <div class="row justify-content-center">
    <div class="col-12 col-sm-10 col-md-6 col-lg-4">
      <div class="p-4">
        ...
        <form id="formPaso1" action="recuperar" method="post" novalidate>
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control border-start-0 py-2" id="txtDato" name="dato" placeholder="Ingresa tu correo o usuario" maxlength="50">
            </div>
          </div>
        ...
        <form id="formPaso2" action="recuperar" method="post" novalidate>
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <input type="text"
                     ...
                     data-tiempo-envio="<%= tiempoEnvio != null ? tiempoEnvio : "" %>">
            </div>
          </div>
          <button class="btn w-100 py-2 rounded-3 text-white fw-medium" type="submit" style="background-color: #4cbab8;">
            Verificar código
        ...
        <form id="formPaso3" action="recuperar" method="post" novalidate>
          <input type="hidden" name="action" value="cambiar">
          <div class="mb-3">
            <label for="pass1" class="form-label fw-bold text-dark mb-1 small">Nueva contraseña *:</label>
            <div class="input-group">
              <span class="input-group-text bg-transparent border-end-0 text-secondary py-2"><i class="bi bi-lock"></i></span>
              <input type="password" class="form-control border-start-0 py-2" id="pass1" name="pass1" placeholder="Nueva contraseña" maxlength="15">
            </div>
          </div>
          <div class="mb-3">
            <label for="pass2" class="form-label fw-bold text-dark mb-1 small">Confirmar contraseña *:</label>
            <div class="input-group">
              <span class="input-group-text bg-transparent border-end-0 text-secondary py-2"><i class="bi bi-lock"></i></span>
              <input type="password" class="form-control border-start-0 py-2" id="pass2" name="pass2" placeholder="Repite la contraseña" maxlength="15">
            </div>
          </div>
          <button class="btn w-100 py-2 rounded-3 text-white fw-medium" type="submit" style="background-color: #4cbab8;">
...
<script src="${pageContext.request.contextPath}/assets/js/Recupera_contra.js"></script>
</body>
</html>