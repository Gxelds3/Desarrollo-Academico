...
<main class="main-content">
    ...
    <form id="formAgregarDesarrollador" action="#" method="POST">
        ...
        <div class="row mb-4">
            <div class="col-md-4">
                <label class="form-label">División Academica <span class="text-danger">*</span> :</label>
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" name="numero_empleado" required placeholder="Núm. Empleado" maxlength="5" minlength="1" pattern="\d{1,5}" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 5)">
            </div>
            <div class="col-md-4">
...
<script src="assets/js/AgregarDesarrollador.js" charset="UTF-8"></script>
<script>
