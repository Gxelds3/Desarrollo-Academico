 ...
 * VerMasEventoCo.js
 *
 * Lógica de la vista de detalle de un evento para el rol Coordinador: carga del evento y de sus participantes.
 */
        ...
        .then(participantes => {
            ...
            if (total === 0) {
                ...
                participantes.forEach(p => {
                    ...
                    let entregadoBtn = `<a href="${contextPath}/cargar_archivo_co.jsp?id=${idEvento}&idUsuarioTarget=${p.id}" class="action-btn" title="Ver espacio del docente"><i class="bi ${p.entregado ? 'bi-eye' : 'bi-eye-slash'}"></i></a>`;
