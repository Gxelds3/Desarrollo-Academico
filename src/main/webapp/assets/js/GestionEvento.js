...
function renderEventos(eventos) {
    ...
    eventos.forEach(function (ev) {
        ...
        let celdas =
            ...
            '<div class="small text-muted truncate-1-line" title="' + escapeHtml(ev.descripcion) + '">' + escapeHtml(ev.descripcion) + '</div>' +
            ...
            '<div class="truncate-1-line" title="' + escapeHtml(ev.institucion) + '">' + escapeHtml(ev.institucion) + '</div>' +

            '<div class="small text-muted truncate-1-line" title="' + escapeHtml(ev.lugar) + '">' + escapeHtml(ev.lugar) + '</div>' +
